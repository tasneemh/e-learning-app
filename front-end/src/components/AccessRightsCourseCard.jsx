...
export default function AccessRightsCourseCard(props) {
  ...
  const accessRightCoursesList = props.accessRightCourses;
  console.log("access right courses list", accessRightCoursesList);
  ...
  const displayAccessRightCourses = accessRightCoursesList.map(
    (course, index) => {
      return (
        <div className="educator-course-card" key={index}>
          ...
          >
            ...
            <CardContent>
              ...
              <div className="educator-course-access-rights">
                Created By: {course.last_name} {", "} {course.first_name}
              </div>
            </CardContent>
